...
import com.pkumar7.datastructures.SegmentTree;
...
class FenwickTreeTest {
    public static void main(String[] args) {
        ...
        long sum = rangeQueryPointUpdate.sum(1, 4);
        System.out.println("sum = " + sum);

        rangeQueryPointUpdate.add(4, 2L);
        long sum1 = rangeQueryPointUpdate.sum(4, 5);
        System.out.println("sum = " + sum1);

        rangeQueryPointUpdate.update(1, 4L);
